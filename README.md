...
- [x] functional on: desktop / laptop (mouse support)
- [x] functional on: tabet devices (touch support)
...
dynamite and stipes          | 🧨 + 🐷      |    | remove all items in the row or column, plus a row or column next to both sides | :construction_worker: TODO
